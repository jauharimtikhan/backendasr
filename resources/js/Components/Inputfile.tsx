const Inputfile = ({
    ...
    return (
        <div>
            ...
            <div className="relative bg-gray-800 rounded-lg border-gray-800 ">
                <input
                    type="file"
                    className="hidden"
                    id="file-upload"
                    onChange={(e) => onChanges && onChanges(e)}
                />
                <label
                    htmlFor="file-upload"
                    className="cursor-pointer flex items-center w-full h-full border border-gray-800 rounded-lg px-4 py-2 bg-gray-700 text-white hover:bg-gray-700 transition duration-300"
                >
                    {/* <svg  */}
                    <svg
                        height={"800px"}
